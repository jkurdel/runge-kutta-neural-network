...
Identyfikację systemu opisanego równaniem \ref{wzor:van_der_pol} ($\mu = 1$) oparto o sieć RBF i metodę selekcji funkcji GOFR. Strukturę zaproponowanej sieci przedstawia rysunek \ref{fig:rbf}.
\begin{figure}[ht!]
	\centering
